...
export default async function Home() {
  ...
  // Initialize Supabase to check if the user is already logged in
  ...
  // If already logged in, skip the login screen and go to admin
  if (user) {
    redirect('/admin');
  }
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-slate-900 text-white">
      {/* Visual Header */}
      <h1 className="text-5xl font-black tracking-tighter uppercase mb-2">Humor Project</h1>
      <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mb-12">Internal Admin Panel</p>

      {/* Login Form - Points to your technical route handler */}
